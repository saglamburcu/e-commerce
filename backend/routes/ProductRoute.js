...
const { getAllProducts, createProduct, updateProduct, deleteProduct, getProductDetail, createProductReview, getSingleProductReviews, deleteReview, getAllCategories } = require("../controller/ProductController");
