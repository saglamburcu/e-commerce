...
const { getAllProducts, createProduct, updateProduct, deleteProduct, getProductDetail, createProductReview, getSingleProductReviews, deleteReview } = require("../controller/ProductController");
